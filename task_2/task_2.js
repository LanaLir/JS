...
//Вытягиваю все именя пользователей из исходного массива и создаю массив с именами

let allUsers = userCard.map(element => element.name);
...
for (i = 0; i < uniq_user.length; i++) {
      ...
      let uniq_user_card = userCard.find(element => element.name == uniq_user[i]);
