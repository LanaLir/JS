...
let search_1 = users.filter(element => element.registrationDate === '09.10.2021');
let search_2 = users.filter(element => element.registrationDate === '10.10.2021');
console.log(search_1.concat(search_2))
}
